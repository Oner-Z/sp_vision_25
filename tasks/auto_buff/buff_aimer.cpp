  ...
  double bullet_speed, bool to_now)
{
  ...
  // std::cout << "x" << aim_in_world.x << "y:" << aim_in_world.y << "z:" << aim_in_world.z << '\n'
  //           << std::endl;
  ...
  // std::cout << "trajectory1.fly_time:" << trajectory1.fly_time
  //           << "  trajectory1.pitch:  " << trajectory1.pitch * 180 / CV_PI << '\n'
  //           << std::endl;
