...
: solver_{solver}, last_timestamp_(std::chrono::steady_clock::now())
{
  ...
  targets_[0] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // hero
  targets_[1] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // engineer
  targets_[2] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // standard 3
  targets_[3] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // standard 4
  targets_[4] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // standard 5
  targets_[5] = Target(4, 0.2, P0_dig_car, min_detect_count, max_temp_lost_count, 100, 100);        // sentry
